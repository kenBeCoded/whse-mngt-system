...
import { User2, Camera, KeyRound, Loader2, Save, UploadCloud } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
          ...
          <CardContent className="space-y-4">
            ...
            <div className="pt-4 border-t flex justify-end">
              <Button 
                ...
                className="bg-primary hover:bg-primary/95 text-white font-extrabold uppercase tracking-widest px-6"
              >
                {isSubmitting ? (
                  <>
